...
class OrganizationRepository:
    # The repository uses the session provided by the service layer.
    ...
    async def create(
        ...
        organization = Organization(
            # Build the ORM model from validated schema data.
    ...
    async def get_by_id(self, organization_id: UUID) -> Organization | None:
        ...
        )  # Return the organization if found, otherwise return None
    ...
    async def update(
        self, organization: Organization, organization_data: OrganizationUpdate
    ) -> Organization:
        updated_data = organization_data.model_dump(
            exclude_unset=True
